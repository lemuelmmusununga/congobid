...
App::import('Vendor', 'phpthumb', array('file' => 'phpthumb'.DS.'phpthumb.php'));
	...
	class Image extends AppModel {
		...
		function storeImage($image_array) {
			...
			$image->writeImage($_SERVER['DOCUMENT_ROOT']."/webroot/img/product_images/thumbs/".$img_name );  

		
			$image->resizeImage( 500, 500 , Imagick::FILTER_LANCZOS, 1, TRUE); //just resize it
			$image->writeImage($_SERVER['DOCUMENT_ROOT']."/webroot/img/product_images/max/".$img_name );   
