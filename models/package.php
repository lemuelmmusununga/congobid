						...
						if(!empty($coupon)){
							switch($coupon['Coupon']['coupon_type_id']){
								...
								case 3:
									...
									$results[$key]['Package']['bids1'] = round($coupon['Coupon']['saving']);
									break;

								case 4:
									$results[$key]['Package']['bids'] += round($results[$key]['Package']['bids'] * ($coupon['Coupon']['saving']/100));
									$results[$key]['Package']['bids1'] = round($results[$key]['Package']['bids'] * ($coupon['Coupon']['saving']/100)); 
								break;
					...
					if(!empty($coupon)){
						switch($coupon['Coupon']['coupon_type_id']){
							...
							case 3:
								...
								$results['Package']['bids1'] = round($coupon['Coupon']['saving']);
								break;

							case 4:
								$results['Package']['bids'] += $results['Package']['bids'] * ($coupon['Coupon']['saving']/100);
								$results['Package']['bids1'] = $results['Package']['bids'] * ($coupon['Coupon']['saving']/100); 
								break;
						...
						$results['Package']['bids1']  = ' '.$coupon['Coupon']['saving'];
					}
				}
			}
