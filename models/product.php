<?php
	class Product extends AppModel {
		...
		function beforeValidate() {
			if(isset($this->data['Product']['rrp']) && empty($this->data['Product']['rrp'])) {
				$this->data['Product']['rrp'] = 0;
			}
			if(isset($this->data['Product']['fixed_price']) && empty($this->data['Product']['fixed_price'])) {
				$this->data['Product']['fixed_price'] = 0;
			}
			if(isset($this->data['Product']['delivery_cost']) && empty($this->data['Product']['delivery_cost'])) {
				$this->data['Product']['delivery_cost'] = 0;
			}
			if(isset($this->data['Product']['autobid_limit']) && empty($this->data['Product']['autobid_limit'])) {
				$this->data['Product']['autobid_limit'] = 0;
			}
			if(isset($this->data['Product']['minimum_price']) && empty($this->data['Product']['minimum_price'])) {
				$this->data['Product']['minimum_price'] = 0;
			}
			if(isset($this->data['Product']['limit_id']) && empty($this->data['Product']['limit_id'])) {
				$this->data['Product']['limit_id'] = 0;
			}
			if(isset($this->data['Product']['stock_number']) && empty($this->data['Product']['stock_number'])) {
				$this->data['Product']['stock_number'] = 0;
			}
			if(isset($this->data['Product']['buy_now']) && empty($this->data['Product']['buy_now'])) {
				$this->data['Product']['buy_now'] = 0;
			}
			if(isset($this->data['Product']['auto_bid_credit']) && empty($this->data['Product']['auto_bid_credit'])) {
				$this->data['Product']['auto_bid_credit'] = 0;
			}
