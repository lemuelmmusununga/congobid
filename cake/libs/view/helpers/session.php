			...
			if (parent::check('Message.' . $key)) {
				...
				if ($flash['layout'] == 'default') {
					if (!empty($flash['params']['class'])) {
						...
						$class = 'main_error message';
					}
					$out = '<div id="' . $key . 'Message" 
					class="main_error message '.$class.'"><div class="error_inner '.$class.'">' . $flash['message'] . '<span class="crose">X</span></div></div>';
