...
<div class="doc_width"><h1> <?php __('Pay for an Auction');?></h1></div>
</div>
...
<div id="rightcol">
	...
	<?php if(!empty($address)) : ?>
		<?php foreach($address as $name => $address) : ?>
			...
			<?php else: ?>
				<p><a href="/addresses/add/<?php echo $name; ?>"><?php __('Add a');?><?php echo $name; ?> <?php __('Address');?></a></p>
			<?php endif; ?>
		<?php endforeach; ?>
	<?php endif; ?>
	...
	<?php else : ?>
		...
		<p><?php __('Less Credits');?>: <?php echo $creditsRequired; ?> (<?php __('from your credit balance of:');?> <?php echo $credits; ?>)</p>
		...
		<?php if($total > 0) : ?>
			...
			<?php if($appConfigurations['gateway'] == true):?>
				<?php if(!empty($paypalData)):?>
					...
					<?php echo $form->hidden('id', array('value' => $auction['Auction']['id'])); ?>
					<?php echo $form->end(__('<img src=\'/img/pay.gif\'', true)); ?>
					<p>
				<?php endif;?>
				...
				<?php if(Configure::read('PaymentGateways.Beanstream.active')) : ?>
					<p>
						<?php echo $form->create('Auction', array('url' => '/payment_gateways/beanstream/auction/'.$auction['Auction']['id']));?>
						<?php echo $form->hidden('id', array('value' => $auction['Auction']['id'])); ?>
						<?php echo $form->end(__('Pay using Beanstream >>', true)); ?>
					</p>
				<?php endif; ?>
				<?php if(Configure::read('PaymentGateways.Payfast.active')) : ?>
					<p>
						<?php echo $form->create('Auction', array('url' => '/payment_gateways/payfast/auction/'.$auction['Auction']['id']));?>
						<?php echo $form->hidden('id', array('value' => $auction['Auction']['id'])); ?>
						<?php echo $form->end(__('Pay using Payfast >>', true)); ?>
					</p>
				<?php endif; ?>
				<?php if(Configure::read('PaymentGateways.Multisafepay.active')) : ?>
					<p>
						<?php echo $form->create('Auction', array('url' => '/payment_gateways/multisafepay/auction/'.$auction['Auction']['id']));?>
						<?php echo $form->hidden('id', array('value' => $auction['Auction']['id'])); ?>
						<?php echo $form->end(__('Pay using Multisafepay >>', true)); ?>
					</p>
				<?php endif; ?>
				...
				<?php if(Configure::read('PaymentGateways.Dalpaycheckout.merchant')):?>
					<p>
						<?php echo $form->create('Auction', array('url' => '/payment_gateways/dalpaycheckout/auction/'.$auction['Auction']['id'].'/mastercard'));?>
						<?php echo $form->hidden('id', array('value' => $auction['Auction']['id'])); ?>
						<?php echo $form->end(__('Pay using DalPay MasterCard >>', true)); ?>
					</p>
				<?php endif;?>
				<?php if(Configure::read('PaymentGateways.Dalpaycheckout.merchant')):?>
					<p>
						<?php echo $form->create('Auction', array('url' => '/payment_gateways/dalpaycheckout/auction/'.$auction['Auction']['id'].'/visa'));?>
						<?php echo $form->hidden('id', array('value' => $auction['Auction']['id'])); ?>
						<?php echo $form->end(__('Pay using DalPay Visa >>', true)); ?>
					</p>
				<?php endif;?>
				<?php if(Configure::read('PaymentGateways.Dalpaycheckout.merchant')):?>
					<p>
						<?php echo $form->create('Auction', array('url' => '/payment_gateways/dalpaycheckout/auction/'.$auction['Auction']['id'].'/amex'));?>
						<?php echo $form->hidden('id', array('value' => $auction['Auction']['id'])); ?>
						<?php echo $form->end(__('Pay using DalPay American Express >>', true)); ?>
					</p>
				<?php endif;?>
				<?php if(Configure::read('PaymentGateways.Ogone.active')):?>
					<p>
						<?php echo $form->create('Auction', array('url' => '/payment_gateways/ogone/auction/'.$auction['Auction']['id']));?>
						<?php echo $form->hidden('id', array('value' => $auction['Auction']['id'])); ?>
						<?php echo $form->end(__('Pay using Ogone >>', true)); ?>
					</p>
				<?php endif;?>
