...
<?php 
//*** Set add-on parameters
if ($buy_it_now) $subcol1_height="375px";
$subcol1_height=false;
$skip_timer=false;
eval(AddonManager::hook('views_auctions_view_top')); 
?>
...
<span><?= __('Retail price')?>: <?php echo $number->currency($auction['Auction']['price'], $appConfigurations['currency']); ?></span>
<span><?= __('Minimum price')?>: <?php echo $number->currency($auction['Product']['rrp'], $appConfigurations['currency']); ?></span>
</div>

<div class="buybids_btn">
<a href="<?php echo $this->webroot; ?>packages"><?= __('Buy More Bids')?></a>
</div>
</div>            
...
<!-- the tabs -->
<ul class="tabs">
	<li id="bid-h" style="margin-right:7px!important;"><strong><?= __('BIDDING')?></strong> <?= __('HISTORY')?></li>
...
<div class="col2">
		...
		<div class="liveauction"><strong><?= __('LIVE')?></strong> <?= __('AUCTION')?></div>               
        <div class="greenline">&nbsp;</div>
		...
		<div class="minumumprice bid-bidder"><?= __('Highest Bidder')?></div>
							...
							<?php if($show_bid_button && !empty($auction['Auction']['isFuture'])) : ?>
							 ...
							 <?php elseif ($show_bid_button) :?>
								 <?php if($session->check('Auth.User')):?>
									...
									<div class="bid-button"><a class="b-login-big" title="<?php echo $auction['Auction']['id'];?>" href="/bid.php?scheck=<?php echo $csrf;?>&id=<?php echo $auction['Auction']['id'];?>"><?= __('Bid Now')?></a></div>
									<?php endif; ?>
								...
								<?php else:?>
									<div class="bid-button"><a href="/users/login" class="b-login-big"><?= __('Bid')?> <label>x2</label></a></div>
								<?php endif;?>
...
<div class="auction_col2_bottom"> 
                       <dl>
							...
							<dt><?= __('PRICE')?></dt>
							<dd><?php echo $number->currency($auction['Product']['rrp'], $appConfigurations['currency']); ?></dd>
							<?php endif; ?>
                            <br style="clear:both;">

							
							<?php if($buy_it_now):?>
								<dt><?= __('RETAIL PRICE')?></dt>
                                
								<dd><?php echo $number->currency($auction['Product']['buy_now'], $appConfigurations['currency']); ?></dd>
							<?php endif; ?>
                            
                    	<br style="clear:both;">
                        <dt class="green_color"><?= __('YOU SAVE')?></dt>
...
<ul class="tabs">
 ...
 <?php if(empty($auction['Auction']['isFuture']) && empty($auction['Auction']['isClosed']) && empty($auction['Auction']['nail_bitter']) && $session->check('Auth.User')):?>
    ...
    you.') ?> <a href="/bidbutlers"> <?= __('Manage')?>  >> </a>
    </p>
