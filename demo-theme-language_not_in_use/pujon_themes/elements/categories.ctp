...
<ul class="categories">
	<li style="margin-bottom:20px;">
		<div class="align-center auction-item">
			<div class="title">
				<h3><a href="/auctions"><?php __('All items');?></a></h3>
	...
	<li style="margin-bottom:20px;">
		<div class="align-center auction-item">
			<div class="title">
				<h3><a href="/auctions/future"><?php __('Future auctions');?></a></h3>
	...
	<li style="margin-bottom:20px;">
		<div class="align-center auction-item">
			<div class="title">
				<h3><a href="/auctions/winners"><?php __('Previous winners');?></a></h3>
	...
	<li style="margin-bottom:20px;">
		<div class="align-center auction-item">
			<div class="title">
				<h3><a href="/auctions/free"><?php __('Free auctions');?></a></h3>
