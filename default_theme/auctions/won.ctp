...
.totalresults{
 ...
 <div class="box clearfix full_li">
 <div class="step_titel">
<div class="doc_width"><h1> <?php __('Won Auctions');?></h1>
<?php
...
<script>
	if ($(window).width() < 514) {
    $('.horizontal-bid-list').removeClass('vertical-bid-list');
} else {
    $('.horizontal-bid-list').addClass('vertical-bid-list');
}
</script>