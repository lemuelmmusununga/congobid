							...
							<?php if($show_bid_button && !empty($auction['Auction']['isFuture'])) : ?>
							 ...
							 <?php elseif($show_bid_button && !empty($auction['Auction']['isClosed'])) : ?>
							  ...
							  <div class="help_icon toolt help_icon_close">
								...
								<?php __('Congratulations to,');?>
								<strong class="bidder_username">
								<?php echo $auction['Leader']['username'];?></strong>
								<?php __('for winning the auction with a bid of ');?>
								<strong class="bid-price"><?php echo $number->currency($auction['Auction']['price'], $appConfigurations['currency']); ?></strong>
								<a href="/auctions/won"> Click here </a><?php __(' to complete your purchase');?> 
								</p>
			   ...
			   <tbody>
				  <?php if(!empty($bidHistories)):?>
					 ...
					 <tr>
						...
						<td><?php echo $bid['User']['first_name'];?></td>
...
<div class="shadow_bg shadow_bg_bidbuddy" style="position:relative">                                         
<ul class="tabs">
