...
<div class="actions">
	<ul>
		...
		<li class="addpage"><?php echo $html->link(__('Delete package', true), array('action' => 'delete', $form->value('id')), null, sprintf(__('Are you sure you want to delete this package?', true))); ?></li>
	</ul>
</div>
