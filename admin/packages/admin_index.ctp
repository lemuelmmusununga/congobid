...
<div class="actions">
	<ul>
		<li class="addpage"><?php echo $html->link(__('Create a new package', true), array('action' => 'add')); ?></li>
	</ul>
</div>
...
?>
	<tr<?php echo $class;?>>
		...
		<td class="actions">
			<span class="edit"><?php echo $html->link(__('Edit', true), array('action' => 'edit', $package['Package']['id'])); ?></span>
			<span class="delete"><?php echo $html->link(__('Delete', true), array('action' => 'delete', $package['Package']['id']), null, sprintf(__('Are you sure you want to delete this package named: %s?', true), $package['Package']['name'])); ?></span>
		</td>
	</tr>
<?php endforeach; ?>
</table>
...
<div class="actions">
	<ul>
		<li class="addpage"><?php echo $html->link(__('Create a new bid package', true), array('action' => 'add')); ?></li>
	</ul>
</div>
