...
<div class="auctions"><h2><?php __('All Transaction');?></h2></div>
<?php if(!empty($accounts)): ?>
	<?php echo $this->element('pagination'); ?>

	<table class="results wonauctions" cellpadding="0" cellspacing="0"  width="100%">
		<tr>
			<th><?php echo $paginator->sort('Transaction Ref no.', 'Account.order_id');?></th>
			...
			<th><?php echo $paginator->sort('Bids', 'Account.credit');?></th>
