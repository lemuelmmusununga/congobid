...
<div class="actions">
	<ul>
		<li class="addpage"><?php echo $html->link(__('Create an Auction', true), array('controller' => 'auctions', 'action' => 'add', $product['Product']['id'])); ?></li>
	</ul>
</div>
...
?>
	<tr<?php echo $class;?>>
		...
		<td class="actions">
			<span><?php echo $html->link(__('View', true), array('admin' => false, 'controller' => 'auctions', 'action' => 'view', $auction['Auction']['id']), array('target' => '_blank')); ?></span>
			...
			<?php elseif(empty($auction['Auction']['closed'])) : ?>
				<span class="edit"> <?php echo $html->link(__('Edit', true), array('controller' => 'auctions', 'action' => 'edit', $auction['Auction']['id'])); ?></span>
			<?php endif; ?>
			...
			<?php else: ?>
				<span class="Delete"> <?php echo $html->link(__('Delete', true), array('controller' => 'auctions', 'action' => 'delete', $auction['Auction']['id']), null, sprintf(__('Are you sure you want to delete auction titled: %s?', true), $auction['Product']['title'])); ?></span>
			<?php endif; ?>
		</td>
	</tr>
<?php endforeach; ?>
