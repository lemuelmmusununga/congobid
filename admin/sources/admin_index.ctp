...
<div class="auctions"><h2><?php __('Sources');?></h2></div>
...
<div class="actions">
	<ul>
		<li class="addpage"><?php echo $html->link(__('Create a new source', true), array('action' => 'add')); ?></li>
	</ul>
</div>
...
?>
	<tr<?php echo $class;?> id="source_<?php echo $source['Source']['id'];?>">
		...
		<td class="actions">
			<span class="edit"><?php echo $html->link(__('Edit', true), array('action'=>'edit', $source['Source']['id'])); ?></span>
			<span class="delete"><?php echo $html->link(__('Delete', true), array('action'=>'delete', $source['Source']['id']), null, sprintf(__('Are you sure you want to delete the source titled: %s?', true), $source['Source']['name'])); ?></span>
		</td>
	</tr>
<?php endforeach; ?>
</tbody>
