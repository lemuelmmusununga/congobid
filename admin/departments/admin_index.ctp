...
<div class="actions">
	<ul>
		<li class="addpage"><?php echo $html->link(__('Add a department', true), array('action' => 'add')); ?></li>
	</ul>
</div>
...
?>
	<tr<?php echo $class;?>>
		...
		<td class="actions" width="33%">
			<span class="edit"><?php echo $html->link(__('Edit', true), array('action' => 'edit', $department['Department']['id'])); ?></span>
			<span class="delete"><?php echo $html->link(__('Delete', true), array('action' => 'delete', $department['Department']['id']), null, sprintf(__('Are you sure you want to delete the department titled: %s?', true), $department['Department']['name'])); ?></span>
		</td>
	</tr>
<?php endforeach; ?>
</table>
