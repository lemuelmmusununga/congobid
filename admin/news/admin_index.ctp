...
<div class="actions">
	<ul>
		<li class="addpage"><?php echo $html->link(__('Add a news article', true), array('action' => 'add')); ?></li>
	</ul>
</div>
...
?>
	<tr<?php echo $class;?>>
		...
		<td class="actions" width="33%">
			<span><?php echo $html->link(__('View', true), array('admin' => false, 'action' => 'view', $news['News']['id']), array('target' => '_blank')); ?></span>
			 <span class="edit"><?php echo $html->link(__('Edit', true), array('action' => 'edit', $news['News']['id'])); ?></span>
			 <span class="delete"><?php echo $html->link(__('Delete', true), array('action' => 'delete', $news['News']['id']), null, sprintf(__('Are you sure you want to delete the article titled: %s?', true), $news['News']['title'])); ?></span>
		</td>
	</tr>
<?php endforeach; ?>
</table>
